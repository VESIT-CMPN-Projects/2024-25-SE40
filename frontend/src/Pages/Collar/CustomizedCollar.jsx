// Pages/Collar/CustomizedCollar.jsx
import React, { useState } from "react";
import "./Products.css";

const CustomizedCollar = () => {
  ...
  return (
    <div className="collar-page">
      <h1>Customized Collar Order</h1>
      <p>
        Upload your design, add the estimated cost, and we'll reach out to you
        on WhatsApp!
      </p>
...
export default CustomizedCollar;
