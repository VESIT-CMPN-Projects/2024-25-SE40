...
const CustomizedCuffs = () => {
  ...
  const sendWhatsAppMessage = () => {
    ...
    const message = `Hello! I want to customize a cuff.\nEstimated Cost: ₹${cost}\n\nI've uploaded the design image. Please check.`;
  ...
  return (
    <div className="collar-page">
      <h1>Customized Cuff Order</h1>
      <p>
        Upload your cuff design, enter estimated cost, and we’ll get in touch!
      </p>
...
export default CustomizedCuffs;
